...
class serial_fram_ui(wx.Frame):
	...
	def __init__(self):
		...
		#*********** Button 1****************#
		hbutton1 = wx.BoxSizer( wx.HORIZONTAL )
		hbutton1.AddSpacer( ( 20, 0), 0, wx.EXPAND, 5 )
		
		self.m_button1 = wx.Button( panel, wx.ID_ANY, "button1", wx.DefaultPosition, wx.DefaultSize, 0 )
		hbutton1.Add( self.m_button1, 0, wx.ALL, 5 )
		self.m_button2 = wx.Button( panel, wx.ID_ANY, "button2", wx.DefaultPosition, wx.DefaultSize, 0 )
		hbutton1.Add( self.m_button2, 0, wx.ALL, 5 )
		self.m_button3 = wx.Button( panel, wx.ID_ANY, "button3", wx.DefaultPosition, wx.DefaultSize, 0 )
		hbutton1.Add( self.m_button3, 0, wx.ALL, 5 )

		#add horizonal 5 to vbox
		vboxsizer1.Add( hbutton1, 0, wx.EXPAND, 5 )
		...
		self.m_button1.Bind(wx.EVT_BUTTON, self.button1_send)
		self.m_button2.Bind(wx.EVT_BUTTON, self.button2_send)
		self.m_button3.Bind(wx.EVT_BUTTON, self.button3_send)
	...
	def button1_send(self, event):
		if self.serial_is_open():
			#************ send **************#
			send_arr = []
			send_arr.append(0xFE)
			send_arr.append(0x40)
			send_arr.append(0x00)
			send_arr.append(0xF5)
			send_arr.append(0x9F)
	...
	def button2_send(self, event):
		if self.serial_is_open():
			#************ send **************#
			send_arr = []
			send_arr.append(0xFE)
			send_arr.append(0x65)
			send_arr.append(0x07)
			send_arr.append(0x5F)
			send_arr.append(0x03)
			send_arr.append(0x00)
			send_arr.append(0x00)
			send_arr.append(0x00)
			send_arr.append(0xFE)
			send_arr.append(0x01)
			send_arr.append(0xC4)
			send_arr.append(0xC1)
	...
	def button3_send(self, event):
		if self.serial_is_open():
			#************ send **************#
			send_arr = []
			send_arr.append(0xFE)
			send_arr.append(0x45)
			send_arr.append(0x02)
			send_arr.append(0x5F)
			send_arr.append(0x14)
			send_arr.append(0x00)
			send_arr.append(0x73)
