...
#ifndef __PCIE_MCC_ARCH_HI3536_HEADER__
#define __PCIE_MCC_ARCH_HI3536_HEADER__
...
#define MISC_CTR_BASE			0x12120000


/* Set 1 to trigger an interrupt[slave] */
#define GLOBAL_SOFT_IRQ			99
