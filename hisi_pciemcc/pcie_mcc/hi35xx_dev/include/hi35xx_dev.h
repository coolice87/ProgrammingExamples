...
#define PCI_VENDOR_HI3536 0x19e5
#define PCI_DEVICE_HI3536 0x3536

#define PCI_VENDOR_HI3519 0x19e5
#define PCI_DEVICE_HI3519 0x3519
...
/*
 * Offset of Key registers in Hi3536 PCIe configuration space
 */
